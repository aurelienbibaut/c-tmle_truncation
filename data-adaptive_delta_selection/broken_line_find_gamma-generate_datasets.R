...
fit_broken_line <- function(results_df, nb_breakpoints = 2, plotting = F){
  ...
  broken_line_points_df <- matrix(0, ncol = 11, nrow = length(fitted_breakpoints) - 1)
...
generate_data_and_gamma_broken_line('L0_exp', lambda, alpha0, beta0, beta1, beta2, n, gamma)
# 
# 
